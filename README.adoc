...
. Töltsük be a projektünket, majd, a jobb felső sarokban kattintsunk a három ponra majd válasszuk az `Edit...` lehetőséget.
...
. Az ezután felugró mezőbe illesszük be a kapott környezeti változót, majd zárjuk be az ablakot.
