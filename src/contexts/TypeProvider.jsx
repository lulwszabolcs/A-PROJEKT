...
const TypeProvider = ({children}) => {
    ...
    async function getVehicleTypes() {
        try {
            ...
            const response = await axios.get("/api/vehicletypes/list",{
                headers: {
    ...
    async function getVehicleStatuses() {
        try {
            setVehicleStatuses(((await axios.get("/api/vehiclestatuses/list",{
                headers: {
    ...
    async function getProblemTypes() {
        try {
            const response = (await axios.get("/api/problemtypes/list",{
                headers: {
                    'Authorization': token ? `Bearer ${token}` : ""
                }
            }))
